...
- Convert US customary quantities, temperatures, and lengths to metric — cups, tablespoons, teaspoons, ounces, pounds, Fahrenheit, and inches all become grams, millilitres, Celsius, or centimetres (a pan size or dough thickness given in inches is still a measurement to convert, not just a quantity of food: "9-inch pan" becomes "23 cm pan", "1/4 inch thick" becomes "6 mm thick"). Round to a sensible cooking precision (nearest 5 g/mL, nearest 5°C, nearest 0.5 cm or 1 mm) rather than false precision, and leave a recipe that's already metric as given.
